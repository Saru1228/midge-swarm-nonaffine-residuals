...
maximum of 12 across $B=1000$ replicates, giving a plus-one tail probability
of 0.000999. This strengthens the observation-level null calibration, but it
...
Future work should proceed along broad rather than overly specific directions.
The most direct extension is comparative application of the
local-affine-subtraction framework to other collective-motion data. Another is
observation stratification, asking why some swarms were robust survivors
whereas others were fragile or stable failures. A fourth is mechanistic
validation through perturbation experiments, richer environmental variables,
or more direct measurements of interaction structure. Code and pseudocode can
support reproducibility in an appendix or repository release, but the main
scientific claim is the measurable residual layer and its reduction
boundaries.
