...
The completed calibration used `B=100` null replicates and 40 non-event
controls per observation per replicate. The observed both-scale count was
`14/19`, whereas the null distribution had mean `4.49`, median `4`, q95 `8`,
q99 `10.01`, and maximum `11`. The plus-one tail probability for reaching or
exceeding the observed count was `0.009900990099009901`. The observed any-scale
count was `15/19`; the corresponding null distribution had mean `10.36`,
median `10.5`, q95 `14`, and maximum `16`, with plus-one tail probability
`0.039603960396039604`.

This result is reported as limited-resolution pipeline-level calibration. It
does not constitute a final high-replicate p-value.
